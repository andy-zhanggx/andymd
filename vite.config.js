...
function buildLabel() {
    var _a, _b;
    var release = (_a = process.env.VITE_RELEASE_NAME) === null || _a === void 0 ? void 0 : _a.trim();
    if (release)
        return release;
    var isCI = !!(process.env.CI || process.env.GITHUB_ACTIONS || process.env.GITLAB_CI);
    if (isCI)
        return '';
    var manual = (_b = process.env.VITE_FEATURE_NAME) === null || _b === void 0 ? void 0 : _b.trim();
    if (manual)
        return manual;
    try {
